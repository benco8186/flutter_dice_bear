...
abstract class EarringComponents {
  static const ComponentGroup variants = {
    'variant06': _variant06,
    'variant01': _variant01,
    'variant02': _variant02,
    'variant03': _variant03,
    'variant04': _variant04,
    'variant05': _variant05,
  };

  static String _variant06(
  ...
  static List<String> get availableVariants => variants.keys.toList();
}
