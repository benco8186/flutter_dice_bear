...
abstract class EyeComponents {
  static const ComponentGroup variants = {
    ...
    'variant07': _variant07,
    'variant08': _variant08,
    'variant09': _variant09,
    'variant10': _variant10,
    'variant11': _variant11,
    'variant12': _variant12,
    'variant13': _variant13,
    'variant14': _variant14,
    'variant15': _variant15,
    'variant16': _variant16,
    'variant17': _variant17,
    'variant18': _variant18,
    'variant19': _variant19,
    'variant20': _variant20,
    'variant21': _variant21,
    'variant22': _variant22,
    'variant23': _variant23,
    'variant24': _variant24,
    'variant25': _variant25,
    'variant26': _variant26,
  };
  static String _variant26(
  ...
  static String _variant05(
    ...
    ColorPickCollection colors,
      ...
      '<path d="M574.5 426.5a66.4 66.4 0 0 1 34 22.7c7.5-5.1 14.7-10.7 22.4-15.7l3 1.3c-.3 2.1-.2 3.6-2.2 4.9l-20 14.2a64.5 64.5 0 0 1 9.8 44c-.5 2.7-3 3.4-5.5 3.6-19.7 1-39.4 3-59 5.4-11 1.5-22.2 2-33.2 3.6l-13.6 1.8c-5 .7-9.5 1.7-14.5.3a65.2 65.2 0 0 1 78.8-86.1Z" fill="#000"/><path d="M565.5 430.4a59.8 59.8 0 0 1 50.7 65.2c-4.7.4-9.5 1-14.2 1.2-18 1.2-36 3.3-53.8 5.4 1-3 2.2-6 2.5-9.2.8-9.3-4.1-18.8-12.3-23.4a25 25 0 0 0-17.5-2.7 24.5 24.5 0 0 0-19.5 25.1 25 25 0 0 0 6.3 15.8l-7.3.7a59.3 59.3 0 0 1 35.4-74.9 60.5 60.5 0 0 1 29.7-3.2Z" fill="#fff"/>';
  static String _variant04(
    ComponentPickCollection components,
    ColorPickCollection colors,
  ) =>
      '<path fill-rule="evenodd" clip-rule="evenodd" d="M613 456a65 65 0 0 0-114.3 3.7c-3.3 6.3-5.2 13-6.5 20-4.4.4-8.8.9-13 2l.3 1.5c.3 1.4.6 2.6 2.3 3 2.3.2 4.8 0 7.1-.3l2.8-.2A65.1 65.1 0 0 0 612 524c6.5-10.2 9.8-22 10-34 .1-3.9-.3-7.5-.8-11.2l-.4-3 3-.2c2.2-.2 4.5-.4 6.8-1 1.1-.5 1.4-1.6 1.6-2.8l.4-1.4c-4.4-1.1-8.7-.8-13.2-.3l-1.4-3.5c-1.5-3.6-3-7.2-5.1-10.7Zm.6 14.7a59.9 59.9 0 0 0-106.7-13.8 58.4 58.4 0 0 0-8.8 22.5c6-.7 11.9-1 17.9-1.5l14.5-1.1 11-.7c4.8-.3 9.6-.5 14.4-1.1 16.4-1.1 32.8-2.4 49.2-3.7l8.5-.6Z" fill="#000"/><path d="M615.1 476.4a59.8 59.8 0 0 1-67.2 71.8 59.7 59.7 0 0 1-50.7-62.9l8.4-.8c.5 6.9 2.8 13.1 8 17.8a24.6 24.6 0 0 0 41.2-21.1c4.5-.5 9-1.1 13.4-1.4 15.7-1 31.3-2.6 47-3.4Z" fill="#fff"/>';
  static String _variant03(
    ComponentPickCollection components,
    ColorPickCollection colors,
  ) =>
      '<path d="M600 480c5 5 10 11 12 18a55 55 0 0 1-7 45c-4 6-9 10-15 14-18 10-39 11-58 7a54 54 0 0 1-28-15c-5-5-8-11-9-18a55 55 0 0 1 6-45c4-6 9-11 15-14 18-10 39-12 58-8a54 54 0 0 1 28 13Z" fill="#000"/><path d="M597 482a49 49 0 0 1-46 64c-14-1-27-7-36-17a48 48 0 0 1 2-66c9-9 22-13 34-14 13-1 26 3 36 11a48 48 0 0 1 10 22Z" fill="#fff"/>';

  static String _variant02(
    ComponentPickCollection components,
    ColorPickCollection colors,
  ) =>
      '<path d="M585 490c4 6 6 13 6 20a45 45 0 0 1-6 30c-5 7-11 12-19 16-14 6-29 6-43 2a45 45 0 0 1-22-12c-5-5-8-12-8-19a45 45 0 0 1 6-30c5-7 11-12 19-16 14-6 29-6 43-2a45 45 0 0 1 22 11Z" fill="#000"/><path d="M580 492a39 39 0 0 1-36 51c-11-1-22-5-29-14a38 38 0 0 1 2-52c8-8 18-11 28-12 10-1 20 2 28 9a38 38 0 0 1 7 18Z" fill="#fff"/>';

  static String _variant01(
    ComponentPickCollection components,
    ColorPickCollection colors,
  ) =>
      '<path d="M570 500c3 5 4 10 4 15a35 35 0 0 1-4 24c-3 5-7 9-12 12-10 5-21 5-31 2a35 35 0 0 1-17-9c-4-4-6-9-6-14a35 35 0 0 1 4-24c3-5 7-9 12-12 10-5 21-5 31-2a35 35 0 0 1 17 8Z" fill="#000"/><path d="M566 502a29 29 0 0 1-27 38c-8-1-16-4-21-11a28 28 0 0 1 2-38c6-6 14-9 22-10 8-1 16 2 22 7a28 28 0 0 1 4 14Z" fill="#fff"/>';
